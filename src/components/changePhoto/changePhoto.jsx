...
function ChangePhoto(props) {
 ...
 const onScaleChange = (scaleChangeEvent) => {
  ...
  <div className='changePhoto'>
   ...
   {showImage && 
    <img  
    src={userProfilePic ? userProfilePic  : "https://icon-library.com/images/no-image-icon/no-image-icon-0.jpg"} 
    alt="Profile"
    className='formImage' />}
    <div className="upload" >
      <label htmlFor="upload" > 
        ...
        <input type="file" name="profilePicBtn" accept="image/png, image/jpeg" onChange={inputHandler} id="upload"  
        style={{display:"none"}} />
    </div>
